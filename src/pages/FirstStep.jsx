  ...
  return (
    <form className="step-form">
      ...
      <div className="first-input">
        <input
          {...register('fSektor' , {required: 'Fəaliyyət Sektorunuzu daxil edin'})}
      ...
      <div className="first-input">
        <input
          {...register('monthIncome' , {required: 'Aylıq Gəlirinizi daxil edin'})}
      ...
      <div className="first-input">
        <input
          {...register('expYear' , {required: 'İş Təcrübənizi(il) daxil edin'})}
      ...
      <div className="first-input">
        <input
          {...register('expMonth' , {required: 'İş Təcrübənizi(ay) daxil edin'})}
      ...
      <div className="first-input">
        <input
          {...register('businessPlace' , {required: 'Biznes Ünvanınızı daxil edin'})}
      ...
      <div className="first-button">
        <Button variant="contained" color="primary" onClick={handleSubmit(handleChangeStep)}>
          Növbəti
        </Button>
      </div>
    </div>
